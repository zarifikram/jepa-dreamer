from ocr.utils_steve import *

from ocr.dvae import dVAE
from ocr.transformer import TransformerEncoder, TransformerDecoder
...
class STEVEEncoder(nn.Module):
    def __init__(self, img_channels, image_size, cnn_hidden_size, d_model, num_iterations, num_slots, slot_size, mlp_hidden_size, num_predictor_blocks, num_predictor_heads, predictor_dropout):
        super().__init__()
...
class STEVEDecoder(nn.Module):
    def __init__(self, vocab_size, d_model, image_size, num_decoder_blocks, num_decoder_heads, dropout):
        super().__init__()
...
class STEVE(nn.Module):
    ...
    def __init__(self, num_iterations, num_slots, cnn_hidden_size, slot_size, mlp_hidden_size, img_channels, image_size, vocab_size, d_model, num_predictor_blocks, num_predictor_heads, predictor_dropout, num_decoder_blocks, num_decoder_heads, dropout):
        super().__init__()
        ...
        # dvae
        self.dvae = dVAE(self.vocab_size, self.img_channels)

        # encoder networks
        self.steve_encoder = STEVEEncoder(
            ...
            num_predictor_blocks=num_predictor_blocks,
            num_predictor_heads=num_predictor_heads, 
            predictor_dropout=predictor_dropout,
        )


        # decoder networks
        self.steve_decoder = STEVEDecoder(
